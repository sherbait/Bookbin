...
<head>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="#"><img id="bookbin_logo" src="img/bookbin_logo_plain.png" class="d-inline-block align-top" alt="bookbin"></a>
            ...
            <?php
                ...
                if (isset($_SESSION["username"])) {
                    ...
                    echo "<input class=\"form_input\" type=\"search\" placeholder=\"Search books...\" aria-label=\"Search\">";
